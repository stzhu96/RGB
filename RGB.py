...
def update_output_image_upload(contents):
    if contents is not None:
        ...
        return html.Div([
            ...
            html.P(f'R通道均值：{m.ravel().tolist()[2]:.2f}，R通道标准差：{dev.ravel().tolist()[2]:.2f}'),
            html.P(f'G通道均值：{m.ravel().tolist()[1]:.2f}，G通道标准差：{dev.ravel().tolist()[1]:.2f}'),
            html.P(f'B通道均值：{m.ravel().tolist()[0]:.2f}，B通道标准差：{dev.ravel().tolist()[0]:.2f}'),
        ])
